...
const XTeam = () => {
	...
	return (
		<div className="ex-members text-center pt-24 text-2xl md:text-4xl font-semibold  bg-gray-100 pb-16">
			<h1 className="font-extrabold text-green-700 text-center font-mono  mb-10">
				IEEE CS PESU <br />{" "}
				<span className="underline text-orange-500">EX-TEAM MEMBERS</span>
			</h1>
			...
			<button
             ...
             focus:ring-4 focus:outline-none focus:ring-purple-200
              ...
              px-6 py-1 mt-10 animate-bounce text-center mr-2 mb-10"
			>
				<BsFillArrowLeftCircleFill className="inline h-7 w-7 m-3" /> Go Back
			</button>
		</div>
	);
};
