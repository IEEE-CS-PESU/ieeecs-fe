            ...
            <div>
              <div className="mt-12 text-white text-center">
                ...
                <p className="pt-2 text-lg md:text-2xl">
                  IEEE CS PES Chapter is here with a recap of our Summer Project
                  Series: We received an overwhelming amount of wonderful ideas,
                ...
                <br />
                {li.map((iii, i) => (
                  <ProjectCard content={content[iii]} key={i} />
                ))}
              </div>
